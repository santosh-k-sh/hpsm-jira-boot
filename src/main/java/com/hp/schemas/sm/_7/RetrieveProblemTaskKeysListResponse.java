 ...
 *       &lt;sequence>
 *         &lt;element name="keys" type="{http://schemas.hp.com/SM/7}ProblemTaskKeysType" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "RetrieveProblemTaskKeysListResponse")
public class RetrieveProblemTaskKeysListResponse {

    @XmlElement(required = true)
    protected List<ProblemTaskKeysType> keys;
     ...
     * 
     */
    public List<ProblemTaskKeysType> getKeys() {
        if (keys == null) {
            keys = new ArrayList<ProblemTaskKeysType>();
        }
        return this.keys;
    }
