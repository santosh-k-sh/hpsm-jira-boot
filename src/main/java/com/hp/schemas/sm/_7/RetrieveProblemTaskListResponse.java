 ...
 *       &lt;sequence>
 *         &lt;element name="instance" type="{http://schemas.hp.com/SM/7}ProblemTaskInstanceType" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "RetrieveProblemTaskListResponse")
public class RetrieveProblemTaskListResponse {

    @XmlElement(required = true)
    protected List<ProblemTaskInstanceType> instance;
     ...
     * 
     */
    public List<ProblemTaskInstanceType> getInstance() {
        if (instance == null) {
            instance = new ArrayList<ProblemTaskInstanceType>();
        }
