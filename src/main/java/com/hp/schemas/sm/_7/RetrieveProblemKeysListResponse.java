 ...
 *       &lt;sequence>
 *         &lt;element name="keys" type="{http://schemas.hp.com/SM/7}ProblemKeysType" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "RetrieveProblemKeysListResponse")
public class RetrieveProblemKeysListResponse {

    @XmlElement(required = true)
    protected List<ProblemKeysType> keys;
     ...
     * 
     */
    public List<ProblemKeysType> getKeys() {
        if (keys == null) {
            keys = new ArrayList<ProblemKeysType>();
        }
        return this.keys;
    }
